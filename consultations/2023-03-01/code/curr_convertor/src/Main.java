...
public class Main {
    public static void main(String[] args) {
        ...
        boolean keyExit = true; // это переменная, которая отвечает за выбор пользователя о продолжении или прекращении работы с программой
        ...
        while (keyExit) {
            ...
            try {
                ...
                int key = scanner.nextInt(); // ввод пользователем 1, 2 или 3
